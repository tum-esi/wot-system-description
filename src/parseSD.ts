...
import { interactionType, loopType, structureType, interactionDir } from "../definitions/enums"
 ...
 */
export default function parseSD(SD: SQSD.sdTemplate) {
    let root
    const actions = {}
    const functions = {}
    const properties = {}
    ...
    const outMashupLogic: SQSD.mashupLogic = {root, actions, functions, properties, name: SD.title}
